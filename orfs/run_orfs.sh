...
# It is strange but for the IHP SG13G2 PDK, another make has to be executed due to an error (no impact) in the first run (reason for || true). 
# Maybe this gets fixed in later versions.
make
